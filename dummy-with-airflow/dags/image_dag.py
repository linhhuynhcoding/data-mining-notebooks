...
from clean.validate_image import validate_image
from clean.clean_image import clean_image
import requests
import os
...
with DAG(
    ...
    # Pipeline
    # [crawl_web, fetch_api] >> preprocess >> 
    [crawl_web, fetch_api] >> clean_image  
    # [rawl_web, fetch_api] >> clean_image >> preprocess >> ...